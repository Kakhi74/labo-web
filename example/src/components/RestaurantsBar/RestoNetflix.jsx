    ...
    <>
      ...
      <div className={style.media_container}>
        <div className={style.media_scroller}>
          <div className={style.media_group} id="group-1">
            <div className={style.media_element}>
              <img
            ...
            <a className={style.next} href="#group-2" aria-label="next">
              <svg>
                <use href="#next"></use>
              </svg>
            </a>
          ...
          <div className={style.media_group} id="group-2">
            <a className={style.previous} href="#group-1">
              <svg>
            ...
            <a className={style.next} href="#group-3" aria-label="next">
              <svg>
                <use href="#next"></use>
              </svg>
            </a>
          ...
          <div className={style.media_group} id="group-3">
            <a className={style.previous} href="#group-2">
              <svg>
                <use href="#previous"></use>
              </svg>
            </a>
            ...
            <a className={style.next} href="#group-4" aria-label="next">
              <svg>
                <use href="#next"></use>
              </svg>
            </a>
          ...
          <div className={style.media_group} id="group-4">
            <a className={style.previous} href="#group-3">
              <svg>
                <use href="#previous"></use>
              </svg>
            </a>
          ...
          <div className={style.navigation_indicators}>
            <div></div>
            <div></div>
            <div></div>
            <div></div>
